  ...
  <div>
      <div>
          <div class="d-flex">
              <div class="col-3"></div>
              <div class="col-5">
                  <input v-model="searchTerm" @input="searchForEvents" class="me-2" type="text" placeholder="Search events..." aria-label="Search">
              </div>
          </div>
          <br>
          <div class="d-flex justify-content-center">
              <button type="button" class="btn btn-secondary btn-pill" :class="{ active: selectedCategory === 'All' }" @click="selectCategory('')">All</button>&nbsp;&nbsp;
          ...
          <div>
              <div v-if="userFilteredEvents.length = 0">
...
export default {
  ...
  methods: {  
    ...
    async fetchEvents() {
     ...
     debounce(func, delay) { //for places API call
     ...
     showEvents(){
      ...
      async searchForCategory(){
          const data = await searchEvents("event_type",this.selectedCategory)
          console.log(data)
          return data
      },
